    ...
    Dialog.prototype = {
        ...
        create: function () {
            ...
            var templates = '<div class="rDialog-wrap">'
                + divHeader + '<div class="rDialog-content">' + (this.settings.content == null ? '' : this.settings.content) + '</div>'
        ...
        time: function (time) {
            var _this = this;
            var _callback = this.settings.timeoutCallback;
            this.closeTimer = setTimeout(function () {
                _this.close();
                if (_callback != null && typeof(_callback) == 'function')_callback();
            }, time || this.settings.time);
        },

        content: function (content) {
            this.dialog.find('.rDialog-content').text(content);
            return this;
        }
